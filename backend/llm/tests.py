...
def test_adversarial_5_unicode_homoglyph_injection(auth_client):
    ...
    est plannifiée en US-28 (COULD Sprint 6) — cf. `security-note.md` §
    « Limites résiduelles ».
    """
...
# ---------------------------------------------------------------------------
# J3 — Couche 4 : Test unitaire du wrapper retry (`generate_quiz_with_retry`).
# Complète les 5 vecteurs d'attaque en garantissant que le retry est bien câblé.
# ---------------------------------------------------------------------------
